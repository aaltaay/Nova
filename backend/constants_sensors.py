...
SENSOR_BOOK_RING = 32
SENSOR_TAPE_RING = 4_000  # enough prints for the flow score's two-minute pace baseline on a busy name (ADR 034)
SENSOR_BAR_LIMIT = 240
SENSOR_SESSION_BAR_LIMIT = 1000   # one 04:00-20:00 ET session of 1Min bars (960), for the session VWAP (ADR 035)
