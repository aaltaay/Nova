...
- Do **not** require a pull request to push. Status-only `master` commits stay allowed. The AI news digest must **not** push `master`; it opens `chore/ai-news-digest` (`.github/workflows/ai-news.yml`).
