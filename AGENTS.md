...
| Date | Change | Author |
|------|--------|--------|
| 2026-09-11 | Master branch protection policy: no force-push/delete (admins included), required gating CI, no required reviews. Tool: `tools/master_branch_protection.py`. Private repo needs GitHub Pro. | User Directive + Cursor Agent |
