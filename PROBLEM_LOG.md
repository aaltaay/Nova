...
- **Fix:** `is_clock_skew_ms` + reason `clock_skew` / `ok`. Face blanks (em dash). Hover: "Clocks disagree by 296ms -- not a real negative fill" plus raw Nova→submit. SELL 3037ms warn path unchanged.
- **Fix class:** admission
