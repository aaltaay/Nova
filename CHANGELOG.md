...
- **Verified by:** Vitest `FundAccountButton` (click calls `openIbkrClientPortal` once). Neighbor `openIbkrClientPortal` + `GlobalAppBar` tests. `npm run lint` / `npm run build`.
