...
- **Verified by:** pytest flatten/trading_allowed/bot session/routes 72 passed; Vitest planFlattenExit/tradingAllowed/closeFullPosition/extendedSession/lock/Activate/Nova Action/KILL neighbors 90 passed; `npx vite build` exit 0; ruff clean; `doc_invariants` OK.
