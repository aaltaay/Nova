...
- **Verified by:** pytest halt/ticks/depth fixtures; Vitest diagnoseBackend, tradingPrerequisites, account/bot pollers, useClosedOrders, sidecarSkip; `test_scripts_ascii` + `tools/test_start_nova_dev_desktop.py`.
