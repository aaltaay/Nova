...
and a few generator strings. Archived ledgers and task-log prose are excluded
on purpose -- archives may narrate past Railway/Alpaca eras.
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print("doc_invariants: OK (live-doc claims)")
    else:
