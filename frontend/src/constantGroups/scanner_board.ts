...
export const SCANNER_CHIP_TITLE: Record<ScannerChipId, string> = {
  ...
  halted: 'Keep halted rows -- live: IBKR tick 49 where Nova holds the line, else the Nasdaq halt feed; '
    + 'played back: the halt / LULD log at that minute. A row whose halt state is not known is kept.',
};
