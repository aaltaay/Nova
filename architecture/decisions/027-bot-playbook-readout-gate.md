...
**Status:** Accepted · **Date:** 2026-09-23 · **Amended by:** [[030-first-pullback-bot-on-paper]] (the read-out gates Live only; Nova's own bot trades Paper and Sim) · [[031-a-scanner-for-every-setup]] (a scanner and a level per setup)
