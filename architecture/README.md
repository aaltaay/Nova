...
| [031](./decisions/031-focus-and-book-watch-sensors.md) | Sensors for agents: the operator's focus, the book watcher (filled vs pulled size, pull patterns), and a recording that keeps every book | Accepted |
