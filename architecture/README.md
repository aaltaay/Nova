...
| [035](./decisions/035-the-bots-read-on-one-stock.md) | The bot's read on one stock: every lane for one symbol, a 2:1 plan on Level 2, signal tiles, the eyes' journal on the desk, setup drawings | Accepted |
