...
`py -3 -m pytest backend/tests/test_l1_minute.py backend/tests/test_archive_write_queue.py backend/tests/test_bars_store.py backend/tests/test_scanner_l1.py backend/tests/test_hod_momo_surge_seed.py backend/tests/test_historical_service.py backend/tests/test_hod_pipeline_fake_feed.py` -- 51 passed.

## Follow-ups

Current open minute stays in RAM until the next print crosses the boundary; a quiet name's last incomplete minute is not stored until it trades again.
