...
**Required** at the end of every completed task that changed code, config, docs policy, agent wiring, or security posture — and after every specialist run that produced a material result (fix, audit conclusion, ops diagnosis).
